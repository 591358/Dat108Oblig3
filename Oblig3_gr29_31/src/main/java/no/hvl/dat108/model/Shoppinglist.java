...
public class Shoppinglist {
	...
	/**
	 * This method will add item to the shopping list if said item is not an empty string or null
	...
	/**
	 * This item will delete a given item when the "delete" button is clicked if the delete value is not null,
	 * and the value exists in the shoppinglist
	...
	public void deleteItemFromList(String delete) {
		...
		//checks if the shoppingList contains said element, if it does, it will delete. This will prevent errors when
